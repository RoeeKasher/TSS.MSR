use tss_rust::{device::{TpmDevice, TpmTbsDevice}, tpm2_impl::*, tpm_structure::TpmEnum, tpm_types::{TPMA_CC, TPMU_CAPABILITIES, TPM_CAP, TPM_CC}};
use std::cmp;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    announce("************************* 🦀🦀🦀 Generated by Tss.Rust 🦀🦀🦀 *************************");
