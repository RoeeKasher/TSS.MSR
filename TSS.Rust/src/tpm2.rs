...
impl Tpm2 {
    ...
    pub fn startup(&mut self, startup_type: tpm_su) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_Startup_REQUEST { startup_type };

        // Send command and process response
        let mut resp = StartupResponse::default();
    ...
    pub fn shutdown(&mut self, shutdown_type: tpm_su) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_Shutdown_REQUEST { shutdown_type };

        // Send command and process response
        let mut resp = ShutdownResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn self_test(&mut self, full_test: u8) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_SelfTest_REQUEST { full_test };

        // Send command and process response
        let mut resp = SelfTestResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn incremental_self_test(
        ...
        // Create request structure
        let req = TPM2_IncrementalSelfTest_REQUEST { to_test };
    ...
    pub fn policy_restart(&mut self, session_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_PolicyRestart_REQUEST { session_handle };

        // Send command and process response
        let mut resp = PolicyRestartResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn read_public(
        ...
        // Create request structure
        let req = TPM2_ReadPublic_REQUEST { object_handle };
    ...
    pub fn unseal(&mut self, item_handle: tpm_handle) -> Result<vec<u8>, TpmError> {
        // Create request structure
        let req = TPM2_Unseal_REQUEST { item_handle };
    ...
    pub fn ecdh_keygen(&mut self, key_handle: tpm_handle) -> Result<ECDH_KeyGenResponse, TpmError> {
        // Create request structure
        let req = TPM2_ECDH_KeyGen_REQUEST { key_handle };
    ...
    pub fn ecc_parameters(
        ...
        // Create request structure
        let req = TPM2_ECC_Parameters_REQUEST { curve_id };
    ...
    pub fn get_random(&mut self, bytes_requested: u16) -> Result<vec<u8>, TpmError> {
        // Create request structure
        let req = TPM2_GetRandom_REQUEST { bytes_requested };
    ...
    pub fn stir_random(&mut self, in_data: vec<u8>) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_StirRandom_REQUEST { in_data };

        // Send command and process response
        let mut resp = StirRandomResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn hash_sequence_start(
        ...
        // Create request structure
        let req = TPM2_HashSequenceStart_REQUEST { auth, hash_alg };
    ...
    pub fn sequence_update(
        ...
        // Send command and process response
        let mut resp = SequenceUpdateResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn ec_ephemeral(
        ...
        // Create request structure
        let req = TPM2_EC_Ephemeral_REQUEST { curve_id };
    ...
    pub fn set_command_code_audit_status(
        ...
        // Send command and process response
        let mut resp = SetCommandCodeAuditStatusResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn pcr_extend(
        ...
        // Send command and process response
        let mut resp = PCR_ExtendResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn pcr_read(
        ...
        // Create request structure
        let req = TPM2_PCR_Read_REQUEST { pcr_selection_in };
    ...
    pub fn pcr_setauthpolicy(
        ...
        // Send command and process response
        let mut resp = PCR_SetAuthPolicyResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn pcr_setauthvalue(
        ...
        // Create request structure
        let req = TPM2_PCR_SetAuthValue_REQUEST { pcr_handle, auth };

        // Send command and process response
        let mut resp = PCR_SetAuthValueResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    ///        Auth Index: 1
    ///        Auth Role: USER
    pub fn pcr_reset(&mut self, pcr_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_PCR_Reset_REQUEST { pcr_handle };

        // Send command and process response
        let mut resp = PCR_ResetResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_ticket(
        ...
        // Send command and process response
        let mut resp = PolicyTicketResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_or(
        ...
        // Send command and process response
        let mut resp = PolicyORResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_pcr(
        ...
        // Send command and process response
        let mut resp = PolicyPCRResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_locality(
        ...
        // Send command and process response
        let mut resp = PolicyLocalityResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_nv(
        ...
        // Send command and process response
        let mut resp = PolicyNVResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_counter_timer(
        ...
        // Send command and process response
        let mut resp = PolicyCounterTimerResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_command_code(
        ...
        // Send command and process response
        let mut resp = PolicyCommandCodeResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    /// policySession: Handle for the policy session being extended
    ///        Auth Index: None
    pub fn policy_physical_presence(&mut self, policy_session: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_PolicyPhysicalPresence_REQUEST { policy_session };

        // Send command and process response
        let mut resp = PolicyPhysicalPresenceResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_cp_hash(
        ...
        // Send command and process response
        let mut resp = PolicyCpHashResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_name_hash(
        ...
        // Send command and process response
        let mut resp = PolicyNameHashResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_duplication_select(
        ...
        // Send command and process response
        let mut resp = PolicyDuplicationSelectResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_authorize(
        ...
        // Send command and process response
        let mut resp = PolicyAuthorizeResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    /// policySession: Handle for the policy session being extended
    ///        Auth Index: None
    pub fn policy_auth_value(&mut self, policy_session: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_PolicyAuthValue_REQUEST { policy_session };

        // Send command and process response
        let mut resp = PolicyAuthValueResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    /// policySession: Handle for the policy session being extended
    ///        Auth Index: None
    pub fn policy_password(&mut self, policy_session: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_PolicyPassword_REQUEST { policy_session };

        // Send command and process response
        let mut resp = PolicyPasswordResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_get_digest(&mut self, policy_session: tpm_handle) -> Result<vec<u8>, TpmError> {
        // Create request structure
        let req = TPM2_PolicyGetDigest_REQUEST { policy_session };
    ...
    pub fn policy_nv_written(
        ...
        // Send command and process response
        let mut resp = PolicyNvWrittenResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_template(
        ...
        // Send command and process response
        let mut resp = PolicyTemplateResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_authorize_nv(
        ...
        // Send command and process response
        let mut resp = PolicyAuthorizeNVResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn hierarchy_control(
        ...
        // Send command and process response
        let mut resp = HierarchyControlResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn set_primary_policy(
        ...
        // Send command and process response
        let mut resp = SetPrimaryPolicyResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    ///        Auth Index: 1
    ///        Auth Role: USER
    pub fn change_pps(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_ChangePPS_REQUEST { auth_handle };

        // Send command and process response
        let mut resp = ChangePPSResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    ///        Auth Handle: 1
    ///        Auth Role: USER
    pub fn change_eps(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_ChangeEPS_REQUEST { auth_handle };

        // Send command and process response
        let mut resp = ChangeEPSResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    ///        Auth Handle: 1
    ///        Auth Role: USER
    pub fn clear(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_Clear_REQUEST { auth_handle };
    ...
    pub fn clear_control(&mut self, auth: tpm_handle, disable: u8) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_ClearControl_REQUEST { auth, disable };

        // Send command and process response
        let mut resp = ClearControlResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn hierarchy_change_auth(
        ...
        // Send command and process response
        let mut resp = HierarchyChangeAuthResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn dictionary_attack_lock_reset(
        ...
        // Create request structure
        let req = TPM2_DictionaryAttackLockReset_REQUEST { lock_handle };

        // Send command and process response
        let mut resp = DictionaryAttackLockResetResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn dictionary_attack_parameters(
        ...
        // Send command and process response
        let mut resp = DictionaryAttackParametersResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn pp_commands(
        ...
        // Send command and process response
        let mut resp = PP_CommandsResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn set_algorithm_set(
        ...
        // Send command and process response
        let mut resp = SetAlgorithmSetResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn field_upgrade_start(
        ...
        // Send command and process response
        let mut resp = FieldUpgradeStartResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn field_upgrade_data(
        ...
        // Create request structure
        let req = TPM2_FieldUpgradeData_REQUEST { fu_data };
    ...
    ///     fuData - Field upgrade image data
    pub fn firmware_read(&mut self, sequence_number: u32) -> Result<vec<u8>, TpmError> {
        // Create request structure
        let req = TPM2_FirmwareRead_REQUEST { sequence_number };
    ...
    pub fn context_save(&mut self, save_handle: tpm_handle) -> Result<tpms_context, TpmError> {
        // Create request structure
        let req = TPM2_ContextSave_REQUEST { save_handle };
    ...
    pub fn context_load(&mut self, context: tpms_context) -> Result<tpm_handle, TpmError> {
        // Create request structure
        let req = TPM2_ContextLoad_REQUEST { context };
    ...
    pub fn flush_context(&mut self, flush_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_FlushContext_REQUEST { flush_handle };

        // Send command and process response
        let mut resp = FlushContextResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn evict_control(
        ...
        // Send command and process response
        let mut resp = EvictControlResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    ///                   TPM2_ReadClock().
    pub fn read_clock(&mut self) -> Result<tpms_time_info, TpmError> {
        // Create request structure
    ...
    pub fn clock_set(&mut self, auth: tpm_handle, new_time: u64) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_ClockSet_REQUEST { auth, new_time };

        // Send command and process response
        let mut resp = ClockSetResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn clock_rate_adjust(
        ...
        // Create request structure
        let req = TPM2_ClockRateAdjust_REQUEST { auth, rate_adjust };

        // Send command and process response
        let mut resp = ClockRateAdjustResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn test_parms(
        ...
        // Create request structure
        let req = TPM2_TestParms_REQUEST { parameters };

        // Send command and process response
        let mut resp = TestParmsResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_definespace(
        ...
        // Send command and process response
        let mut resp = NV_DefineSpaceResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_undefinespace(
        ...
        // Send command and process response
        let mut resp = NV_UndefineSpaceResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_undefinespacespecial(
        ...
        // Create request structure
        let req = TPM2_NV_UndefineSpaceSpecial_REQUEST { nv_index, platform };

        // Send command and process response
        let mut resp = NV_UndefineSpaceSpecialResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_readpublic(
        ...
        // Create request structure
        let req = TPM2_NV_ReadPublic_REQUEST { nv_index };
    ...
    pub fn nv_write(
        ...
        // Send command and process response
        let mut resp = NV_WriteResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_increment(
        ...
        // Send command and process response
        let mut resp = NV_IncrementResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_extend(
        ...
        // Send command and process response
        let mut resp = NV_ExtendResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_setbits(
        ...
        // Send command and process response
        let mut resp = NV_SetBitsResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_writelock(
        ...
        // Send command and process response
        let mut resp = NV_WriteLockResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    ///        Auth Index: 1
    ///        Auth Role: USER
    pub fn nv_globalwritelock(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure
        let req = TPM2_NV_GlobalWriteLock_REQUEST { auth_handle };

        // Send command and process response
        let mut resp = NV_GlobalWriteLockResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_readlock(
        ...
        // Send command and process response
        let mut resp = NV_ReadLockResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn nv_changeauth(
        ...
        // Create request structure
        let req = TPM2_NV_ChangeAuth_REQUEST { nv_index, new_auth };

        // Send command and process response
        let mut resp = NV_ChangeAuthResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn policy_ac_send_select(
        ...
        // Send command and process response
        let mut resp = Policy_AC_SendSelectResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn act_settimeout(
        ...
        // Send command and process response
        let mut resp = ACT_SetTimeoutResponse::default();
        self.dispatch(req, &mut resp)?;
        Ok(())
    }
    ...
    pub fn vendor_tcg_test(&mut self, input_data: vec<u8>) -> Result<vec<u8>, TpmError> {
        // Create request structure
        let req = TPM2_Vendor_TCG_Test_REQUEST { input_data };
...
impl<'a> AsyncMethods<'a> {
    ...
    /// TPM receives TPM2_Startup() when it is not required, the TPM shall return TPM_RC_INITIALIZE.
    /// startupType: TPM_SU_CLEAR or TPM_SU_STATE
    pub fn startup_async(&mut self, startup_type: tpm_su) -> Result<(), TpmError> {
    ...
    /// indicates how the subsequent TPM2_Startup() will be processed.
    /// shutdownType: TPM_SU_CLEAR or TPM_SU_STATE
    pub fn shutdown_async(&mut self, shutdown_type: tpm_su) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_Shutdown_REQUEST { shutdown_type };
    ...
    /// fullTest: YES if full test to be performed
    ///        NO if only test of untested functions required
    pub fn self_test_async(&mut self, full_test: u8) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_SelfTest_REQUEST { full_test };
    ...
    ///               contains manufacturer-specific information
    ///     testResult - TBD
    pub fn get_test_result_async(&mut self) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_GetTestResult_REQUEST::default();
        self.tpm.dispatch_async_command(req)
    }
    ...
    /// may then succeed.
    /// sessionHandle: The handle for the policy session
    pub fn policy_restart_async(&mut self, session_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_PolicyRestart_REQUEST { session_handle };
    ...
    ///     name - Name of the object
    ///     qualifiedName - The Qualified Name of the object
    pub fn read_public_async(&mut self, object_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ReadPublic_REQUEST { object_handle };
    ...
    ///     outData - Unsealed data
    ///               Size of outData is limited to be no more than 128 octets.
    pub fn unseal_async(&mut self, item_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_Unseal_REQUEST { item_handle };
    ...
    ///     zPoint - Results of P h[de]Qs
    ///     pubPoint - Generated ephemeral public point (Qe)
    pub fn ecdh_keygen_async(&mut self, key_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ECDH_KeyGen_REQUEST { key_handle };
    ...
    /// curveID: Parameter set selector
    ///     parameters - ECC parameters for the selected curve
    pub fn ecc_parameters_async(&mut self, curve_id: tpm_ecc_curve) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ECC_Parameters_REQUEST { curve_id };
    ...
    /// bytesRequested: Number of octets to return
    ///     randomBytes - The random octets
    pub fn get_random_async(&mut self, bytes_requested: u16) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_GetRandom_REQUEST { bytes_requested };
    ...
    /// This command is used to add "additional information" to the RNG state.
    /// inData: Additional information
    pub fn stir_random_async(&mut self, in_data: vec<u8>) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_StirRandom_REQUEST { in_data };
    ...
    ///     Q - Ephemeral public key Q [r]G
    ///     counter - Least-significant 16 bits of commitCount
    pub fn ec_ephemeral_async(&mut self, curve_id: tpm_ecc_curve) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_EC_Ephemeral_REQUEST { curve_id };
    ...
    ///        Auth Index: 1
    ///        Auth Role: USER
    pub fn pcr_reset_async(&mut self, pcr_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_PCR_Reset_REQUEST { pcr_handle };
    ...
    /// policySession: Handle for the policy session being extended
    ///        Auth Index: None
    pub fn policy_auth_value_async(&mut self, policy_session: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_PolicyAuthValue_REQUEST { policy_session };
    ...
    /// policySession: Handle for the policy session being extended
    ///        Auth Index: None
    pub fn policy_password_async(&mut self, policy_session: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_PolicyPassword_REQUEST { policy_session };
    ...
    ///        Auth Index: None
    ///     policyDigest - The current value of the policySessionpolicyDigest
    pub fn policy_get_digest_async(&mut self, policy_session: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_PolicyGetDigest_REQUEST { policy_session };
    ...
    ///        Auth Index: 1
    ///        Auth Role: USER
    pub fn change_pps_async(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ChangePPS_REQUEST { auth_handle };
    ...
    ///        Auth Handle: 1
    ///        Auth Role: USER
    pub fn change_eps_async(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ChangeEPS_REQUEST { auth_handle };
    ...
    ///        Auth Handle: 1
    ///        Auth Role: USER
    pub fn clear_async(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_Clear_REQUEST { auth_handle };
    ...
    ///        Auth Role: USER
    /// disable: YES if the disableOwnerClear flag is to be SET, NO if the flag is to be CLEAR.
    pub fn clear_control_async(&mut self, auth: tpm_handle, disable: u8) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ClearControl_REQUEST { auth, disable };
    ...
    ///                  TPM_ALG_NULL if field update is complete
    ///     firstDigest - Tagged digest of the first block of the sequence
    pub fn field_upgrade_data_async(&mut self, fu_data: vec<u8>) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_FieldUpgradeData_REQUEST { fu_data };
    ...
    ///        set to 0 on the first call
    ///     fuData - Field upgrade image data
    pub fn firmware_read_async(&mut self, sequence_number: u32) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_FirmwareRead_REQUEST { sequence_number };
    ...
    ///               as the values when the context was saved (TPM2_ContextSave()), then the TPM
    ///               shall not load the context.
    pub fn context_save_async(&mut self, save_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ContextSave_REQUEST { save_handle };
    ...
    /// context: The context blob
    ///     handle - The handle assigned to the resource after it has been successfully loaded
    pub fn context_load_async(&mut self, context: tpms_context) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ContextLoad_REQUEST { context };
    ...
    /// flushHandle: The handle of the item to flush
    ///        NOTE This is a use of a handle as a parameter.
    pub fn flush_context_async(&mut self, flush_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_FlushContext_REQUEST { flush_handle };
    ...
    ///     currentTime - This structure is used in, e.g., the TPM2_GetTime() attestation and
    ///                   TPM2_ReadClock().
    pub fn read_clock_async(&mut self) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ReadClock_REQUEST::default();
        self.tpm.dispatch_async_command(req)
    }
    ...
    ///        Auth Role: USER
    /// newTime: New Clock setting in milliseconds
    pub fn clock_set_async(&mut self, auth: tpm_handle, new_time: u64) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_ClockSet_REQUEST { auth, new_time };
    ...
    ///     nvPublic - The public area of the NV Index
    ///     nvName - The Name of the nvIndex
    pub fn nv_readpublic_async(&mut self, nv_index: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_NV_ReadPublic_REQUEST { nv_index };
    ...
    ///        Auth Index: 1
    ///        Auth Role: USER
    pub fn nv_globalwritelock_async(&mut self, auth_handle: tpm_handle) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_NV_GlobalWriteLock_REQUEST { auth_handle };
    ...
    /// inputData: Dummy data
    ///     outputData - Dummy data
    pub fn vendor_tcg_test_async(&mut self, input_data: vec<u8>) -> Result<(), TpmError> {
        // Create request structure and dispatch async command
        let req = TPM2_Vendor_TCG_Test_REQUEST { input_data };
    ...
    /// successfully. If a TPM requires TPM2_Startup() and another command is received, or if the
    /// TPM receives TPM2_Startup() when it is not required, the TPM shall return TPM_RC_INITIALIZE.
    pub fn startup_complete(&mut self) -> Result<(), TpmError> {
    ...
    /// This command is used to prepare the TPM for a power cycle. The shutdownType parameter
    /// indicates how the subsequent TPM2_Startup() will be processed.
    pub fn shutdown_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ShutdownResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// the TPM will test all functions. If fullTest = NO, the TPM will only test those functions
    /// that have not previously been tested.
    pub fn self_test_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = SelfTestResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command causes the TPM to perform a test of the selected algorithms.
    ///     toDoList - List of algorithms that need testing
    pub fn incremental_self_test_complete(&mut self) -> Result<vec<tpm_alg_id>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = IncrementalSelfTestResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.to_do_list)
    ...
    ///               contains manufacturer-specific information
    ///     testResult - TBD
    pub fn get_test_result_complete(&mut self) -> Result<GetTestResultResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = GetTestResultResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     handle - Handle for the newly created session
    ///     nonceTPM - The initial nonce from the TPM, used in the computation of the sessionKey
    pub fn start_auth_session_complete(&mut self) -> Result<StartAuthSessionResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = StartAuthSessionResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// session restarts with the same nonceTPM. If the PCR are valid for the policy, the policy
    /// may then succeed.
    pub fn policy_restart_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyRestartResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///     creationTicket - Ticket used by TPM2_CertifyCreation() to validate that the creation
    ///                      data was produced by the TPM
    pub fn create_complete(&mut self) -> Result<CreateResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = CreateResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     handle - Handle of type TPM_HT_TRANSIENT for the loaded object
    ///     name - Name of the loaded object
    pub fn load_complete(&mut self) -> Result<LoadResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = LoadResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     handle - Handle of type TPM_HT_TRANSIENT for the loaded object
    ///     name - Name of the loaded object
    pub fn load_external_complete(&mut self) -> Result<LoadExternalResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = LoadExternalResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     name - Name of the object
    ///     qualifiedName - The Qualified Name of the object
    pub fn read_public_complete(&mut self) -> Result<ReadPublicResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ReadPublicResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///                the data should be no larger than the size of the digest of the nameAlg
    ///                associated with keyHandle
    pub fn activate_credential_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ActivateCredentialResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.cert_info)
    ...
    ///     credentialBlob - The credential
    ///     secret - Handle algorithm-dependent data that wraps the key that encrypts credentialBlob
    pub fn make_credential_complete(&mut self) -> Result<MakeCredentialResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = MakeCredentialResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     outData - Unsealed data
    ///               Size of outData is limited to be no more than 128 octets.
    pub fn unseal_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = UnsealResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.out_data)
    ...
    /// This command is used to change the authorization secret for a TPM-resident object.
    ///     outPrivate - Private area containing the new authorization value
    pub fn object_change_auth_complete(&mut self) -> Result<tpm2b_private, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ObjectChangeAuthResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.out_private)
    ...
    ///     outPublic - The public portion of the created object
    ///     name - The name of the created object
    pub fn create_loaded_complete(&mut self) -> Result<CreateLoadedResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = CreateLoadedResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     duplicate - Private area that may be encrypted by encryptionKeyIn; and may be doubly encrypted
    ///     outSymSeed - Seed protected by the asymmetric algorithms of new parent (NP)
    pub fn duplicate_complete(&mut self) -> Result<DuplicateResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = DuplicateResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     outDuplicate - An object encrypted using symmetric key derived from outSymSeed
    ///     outSymSeed - Seed for a symmetric key protected by newParent asymmetric key
    pub fn rewrap_complete(&mut self) -> Result<RewrapResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = RewrapResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// imported object (duplicate) may be singly encrypted, multiply encrypted, or unencrypted.
    ///     outPrivate - The sensitive area encrypted with the symmetric key of parentHandle
    pub fn import_complete(&mut self) -> Result<tpm2b_private, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ImportResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.out_private)
    ...
    /// shall either be TPM_ALG_NULL or be the same as scheme (TPM_RC_SCHEME).
    ///     outData - Encrypted output
    pub fn rsa_encrypt_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = RSA_EncryptResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.out_data)
    ...
    /// RFC 8017 ((PKCS#1).
    ///     message - Decrypted output
    pub fn rsa_decrypt_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = RSA_DecryptResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.message)
    ...
    ///     zPoint - Results of P h[de]Qs
    ///     pubPoint - Generated ephemeral public point (Qe)
    pub fn ecdh_keygen_complete(&mut self) -> Result<ECDH_KeyGenResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ECDH_KeyGenResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// is the cofactor of the curve).
    ///     outPoint - X and Y coordinates of the product of the multiplication Z = (xZ , yZ) [hdS]QB
    pub fn ecdh_zgen_complete(&mut self) -> Result<tpms_ecc_point, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ECDH_ZGenResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.out_point)
    ...
    /// This command returns the parameters of an ECC curve identified by its TCG-assigned curveID.
    ///     parameters - ECC parameters for the selected curve
    pub fn ecc_parameters_complete(&mut self) -> Result<tpms_algorithm_detail_ecc, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ECC_ParametersResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.parameters)
    ...
    ///     outZ1 - X and Y coordinates of the computed value (scheme dependent)
    ///     outZ2 - X and Y coordinates of the second computed value (scheme dependent)
    pub fn zgen_2phase_complete(&mut self) -> Result<ZGen_2PhaseResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ZGen_2PhaseResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     C2 - The data block produced by the XOR process
    ///     C3 - The integrity value
    pub fn ecc_encrypt_complete(&mut self) -> Result<ECC_EncryptResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ECC_EncryptResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// This command performs ECC decryption.
    ///     plainText - Decrypted output
    pub fn ecc_decrypt_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ECC_DecryptResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.plain_text)
    ...
    ///     outData - Encrypted or decrypted output
    ///     ivOut - Chaining value to use for IV in next round
    pub fn encrypt_decrypt_complete(&mut self) -> Result<EncryptDecryptResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = EncryptDecryptResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     outData - Encrypted or decrypted output
    ///     ivOut - Chaining value to use for IV in next round
    pub fn encrypt_decrypt2_complete(&mut self) -> Result<EncryptDecrypt2Response, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = EncryptDecrypt2Response::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///                  did not start with TPM_GENERATED_VALUE
    ///                  will be a NULL ticket if the digest may not be signed with a restricted key
    pub fn hash_complete(&mut self) -> Result<HashResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = HashResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// This command performs an HMAC on the supplied data using the indicated hash algorithm.
    ///     outHMAC - The returned HMAC in a sized buffer
    pub fn hmac_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = HMACResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.out_hmac)
    ...
    /// indicated algorithm.
    ///     outMAC - The returned MAC in a sized buffer
    pub fn mac_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = MACResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.out_mac)
    ...
    /// This command returns the next bytesRequested octets from the random number generator (RNG).
    ///     randomBytes - The random octets
    pub fn get_random_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = GetRandomResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.random_bytes)
    ...
    /// This command is used to add "additional information" to the RNG state.
    pub fn stir_random_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = StirRandomResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// to the value in auth.
    ///     handle - A handle to reference the sequence
    pub fn hmac_start_complete(&mut self) -> Result<tpm_handle, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = HMAC_StartResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.handle)
    ...
    /// to the value in auth.
    ///     handle - A handle to reference the sequence
    pub fn mac_start_complete(&mut self) -> Result<tpm_handle, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = MAC_StartResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.handle)
    ...
    /// TPM_RC_HASH.
    ///     handle - A handle to reference the sequence
    pub fn hash_sequence_start_complete(&mut self) -> Result<tpm_handle, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = HashSequenceStartResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.handle)
    ...
    /// This command is used to add data to a hash or HMAC sequence. The amount of data in buffer
    /// may be any size up to the limits of the TPM.
    pub fn sequence_update_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = SequenceUpdateResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///                  did not start with TPM_GENERATED_VALUE
    ///                  This is a NULL Ticket when the sequence is HMAC.
    pub fn sequence_complete_complete(&mut self) -> Result<SequenceCompleteResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = SequenceCompleteResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// extended with the associated digest value from the list.
    ///     results - List of digests computed for the PCR
    pub fn event_sequence_complete_complete(&mut self) -> Result<vec<tpmt_ha>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = EventSequenceCompleteResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.results)
    ...
    ///     certifyInfo - The structure that was signed
    ///     signature - The asymmetric signature over certifyInfo using the key referenced by signHandle
    pub fn certify_complete(&mut self) -> Result<CertifyResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = CertifyResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     certifyInfo - The structure that was signed
    ///     signature - The signature over certifyInfo
    pub fn certify_creation_complete(&mut self) -> Result<CertifyCreationResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = CertifyCreationResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     quoted - The quoted information
    ///     signature - The signature over quoted
    pub fn quote_complete(&mut self) -> Result<QuoteResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = QuoteResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     timeInfo - Standard TPM-generated attestation block
    ///     signature - The signature over timeInfo
    pub fn get_time_complete(&mut self) -> Result<GetTimeResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = GetTimeResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     tbsDigest - The digest that was signed
    ///     signature - The signature over tbsDigest
    pub fn certify_x509_complete(&mut self) -> Result<CertifyX509Response, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = CertifyX509Response::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     E - ECC point E [r]P1
    ///     counter - Least-significant 16 bits of commitCount
    pub fn commit_complete(&mut self) -> Result<CommitResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = CommitResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     Q - Ephemeral public key Q [r]G
    ///     counter - Least-significant 16 bits of commitCount
    pub fn ec_ephemeral_complete(&mut self) -> Result<EC_EphemeralResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = EC_EphemeralResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///                  has validated that a digest was signed by a key with the Name of keyName.
    ///                  The ticket is computed by
    pub fn verify_signature_complete(&mut self) -> Result<tpmt_tk_verified, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = VerifySignatureResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.validation)
    ...
    /// symmetric or asymmetric signing key.
    ///     signature - The signature
    pub fn sign_complete(&mut self) -> Result<Option<Box<dyn TPMU_SIGNATURE>>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = SignResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.signature)
    ...
    /// status of a command or to set the hash algorithm used for the audit digest, but not both
    /// at the same time.
    pub fn set_command_code_audit_status_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = SetCommandCodeAuditStatusResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// contains one or more tagged digest values identified by an algorithm ID. For each digest,
    /// the PCR associated with pcrHandle is Extended into the bank identified by the tag (hashAlg).
    pub fn pcr_extend_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PCR_ExtendResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///               the algorithm used to compute the digest and, by implication, the size of
    ///               the digest.
    pub fn pcr_event_complete(&mut self) -> Result<vec<tpmt_ha>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PCR_EventResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.digests)
    ...
    ///     pcrValues - The contents of the PCR indicated in pcrSelectOut-˃ pcrSelection[] as
    ///                 tagged digests
    pub fn pcr_read_complete(&mut self) -> Result<PCR_ReadResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PCR_ReadResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     sizeNeeded - Number of octets required to satisfy the request
    ///     sizeAvailable - Number of octets available. Computed before the allocation.
    pub fn pcr_allocate_complete(&mut self) -> Result<PCR_AllocateResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PCR_AllocateResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// This command is used to associate a policy with a PCR or group of PCR. The policy
    /// determines the conditions under which a PCR may be extended or reset.
    pub fn pcr_setauthpolicy_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PCR_SetAuthPolicyResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command changes the authValue of a PCR or group of PCR.
    pub fn pcr_setauthvalue_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PCR_SetAuthValueResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// then this command may be used to set the PCR in all banks to zero. The attributes of the
    /// PCR may restrict the locality that can perform the reset operation.
    pub fn pcr_reset_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PCR_ResetResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///                    non-zero; this ticket will use the TPMT_ST_AUTH_SIGNED structure tag.
    ///                    See 23.2.5
    pub fn policy_signed_complete(&mut self) -> Result<PolicySignedResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicySignedResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///                    non-zero ( See 23.2.5). This ticket will use the TPMT_ST_AUTH_SECRET
    ///                    structure tag
    pub fn policy_secret_complete(&mut self) -> Result<PolicySecretResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicySecretResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// signed authorization. The ticket represents a validated authorization that had an
    /// expiration time associated with it.
    pub fn policy_ticket_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyTicketResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// only evaluate one set that satisfies the policy. This command will indicate that one of
    /// the required sets of conditions has been satisfied.
    pub fn policy_or_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyORResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// together with TPM2_PolicyOR() allows one group of authorizations to occur when PCR are in
    /// one state and a different set of authorizations when the PCR are in a different state.
    pub fn policy_pcr_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyPCRResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command indicates that the authorization will be limited to a specific locality.
    pub fn policy_locality_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyLocalityResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// NV Index. It is an immediate assertion. The NV index is validated during the
    /// TPM2_PolicyNV() command, not when the session is used for authorization.
    pub fn policy_nv_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyNVResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command is used to cause conditional gating of a policy based on the contents of the
    /// TPMS_TIME_INFO structure.
    pub fn policy_counter_timer_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyCounterTimerResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command indicates that the authorization will be limited to a specific command code.
    pub fn policy_command_code_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyCommandCodeResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command indicates that physical presence will need to be asserted at the time the
    /// authorization is performed.
    pub fn policy_physical_presence_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyPhysicalPresenceResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command is used to allow a policy to be bound to a specific command and command parameters.
    pub fn policy_cp_hash_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyCpHashResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// bound to the parameters of the command. This is most useful for commands such as
    /// TPM2_Duplicate() and for TPM2_PCR_Event() when the referenced PCR requires a policy.
    pub fn policy_name_hash_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyNameHashResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows qualification of duplication to allow duplication to a selected new parent.
    pub fn policy_duplication_select_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyDuplicationSelectResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// difficult to add users to a policy. This command lets a policy authority sign a new policy
    /// so that it may be used in an existing policy.
    pub fn policy_authorize_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyAuthorizeResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows a policy to be bound to the authorization value of the authorized entity.
    pub fn policy_auth_value_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyAuthValueResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows a policy to be bound to the authorization value of the authorized object.
    pub fn policy_password_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyPasswordResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// to be used to perform the actions required to pre-compute the authPolicy for an object.
    ///     policyDigest - The current value of the policySessionpolicyDigest
    pub fn policy_get_digest_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyGetDigestResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.policy_digest)
    ...
    /// deferred assertion. Values are stored in the policy session context and checked when the
    /// policy is used for authorization.
    pub fn policy_nv_written_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyNvWrittenResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// useful for an object creation command such as TPM2_Create(), TPM2_CreatePrimary(), or
    /// TPM2_CreateLoaded().
    pub fn policy_template_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyTemplateResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// not be withdrawn. With this command, the approved policy is kept in an NV Index location
    /// so that the policy may be changed as needed to render the old policy unusable.
    pub fn policy_authorize_nv_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PolicyAuthorizeNVResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///                      data was produced by the TPM
    ///     name - The name of the created object
    pub fn create_primary_complete(&mut self) -> Result<CreatePrimaryResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = CreatePrimaryResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// command allows phEnable, phEnableNV, shEnable, and ehEnable to be changed when the proper
    /// authorization is provided.
    pub fn hierarchy_control_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = HierarchyControlResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// endorsement hierarchy (endorsementPolicy). On TPMs implementing Authenticated Countdown
    /// Timers (ACT), this command may also be used to set the authorization policy for an ACT.
    pub fn set_primary_policy_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = SetPrimaryPolicyResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This replaces the current platform primary seed (PPS) with a value from the RNG and sets
    /// platformPolicy to the default initialization value (the Empty Buffer).
    pub fn change_pps_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ChangePPSResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// flush any resident objects (transient or persistent) in the Endorsement hierarchy and not
    /// allow objects in the hierarchy associated with the previous EPS to be loaded.
    pub fn change_eps_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ChangeEPSResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command removes all TPM context associated with a specific Owner.
    pub fn clear_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ClearResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// TPM2_ClearControl() disables and enables the execution of TPM2_Clear().
    pub fn clear_control_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ClearControlResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows the authorization secret for a hierarchy or lockout to be changed
    /// using the current authorization value as the command authorization.
    pub fn hierarchy_change_auth_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = HierarchyChangeAuthResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// authorization failures. If this command is properly authorized, the lockout counter is set
    /// to zero.
    pub fn dictionary_attack_lock_reset_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = DictionaryAttackLockResetResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command changes the lockout parameters.
    pub fn dictionary_attack_parameters_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = DictionaryAttackParametersResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command is used to determine which commands require assertion of Physical Presence
    /// (PP) in addition to platformAuth/platformPolicy.
    pub fn pp_commands_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = PP_CommandsResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows the platform to change the set of algorithms that are used by the TPM.
    /// The algorithmSet setting is a vendor-dependent value.
    pub fn set_algorithm_set_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = SetAlgorithmSetResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command uses platformPolicy and a TPM Vendor Authorization Key to authorize a Field
    /// Upgrade Manifest.
    pub fn field_upgrade_start_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = FieldUpgradeStartResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///                  TPM_ALG_NULL if field update is complete
    ///     firstDigest - Tagged digest of the first block of the sequence
    pub fn field_upgrade_data_complete(&mut self) -> Result<FieldUpgradeDataResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = FieldUpgradeDataResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// This command is used to read a copy of the current firmware installed in the TPM.
    ///     fuData - Field upgrade image data
    pub fn firmware_read_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = FirmwareReadResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.fu_data)
    ...
    ///               as the values when the context was saved (TPM2_ContextSave()), then the TPM
    ///               shall not load the context.
    pub fn context_save_complete(&mut self) -> Result<tpms_context, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ContextSaveResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.context)
    ...
    /// This command is used to reload a context that has been saved by TPM2_ContextSave().
    ///     handle - The handle assigned to the resource after it has been successfully loaded
    pub fn context_load_complete(&mut self) -> Result<tpm_handle, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ContextLoadResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.handle)
    ...
    /// This command causes all context associated with a loaded object, sequence object, or
    /// session to be removed from TPM memory.
    pub fn flush_context_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = FlushContextResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows certain Transient Objects to be made persistent or a persistent object
    /// to be evicted.
    pub fn evict_control_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = EvictControlResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///     currentTime - This structure is used in, e.g., the TPM2_GetTime() attestation and
    ///                   TPM2_ReadClock().
    pub fn read_clock_complete(&mut self) -> Result<tpms_time_info, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ReadClockResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.current_time)
    ...
    /// FFFF00000000000016. If both of these checks succeed, Clock is set to newTime. If either of
    /// these checks fails, the TPM shall return TPM_RC_VALUE and make no change to Clock.
    pub fn clock_set_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ClockSetResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command adjusts the rate of advance of Clock and Time to provide a better
    /// approximation to real time.
    pub fn clock_rate_adjust_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ClockRateAdjustResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///     moreData - Flag to indicate if there are more values of this type
    ///     capabilityData - The capability data
    pub fn get_capability_complete(&mut self) -> Result<GetCapabilityResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = GetCapabilityResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// This command is used to check to see if specific combinations of algorithm parameters are supported.
    pub fn test_parms_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = TestParmsResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// hold the data associated with the NV Index. If a definition already exists at the NV
    /// Index, the TPM will return TPM_RC_NV_DEFINED.
    pub fn nv_definespace_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_DefineSpaceResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command removes an Index from the TPM.
    pub fn nv_undefinespace_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_UndefineSpaceResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows removal of a platform-created NV Index that has TPMA_NV_POLICY_DELETE SET.
    pub fn nv_undefinespacespecial_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_UndefineSpaceSpecialResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///     nvPublic - The public area of the NV Index
    ///     nvName - The Name of the nvIndex
    pub fn nv_readpublic_complete(&mut self) -> Result<NV_ReadPublicResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_ReadPublicResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// This command writes a value to an area in NV memory that was previously defined by
    /// TPM2_NV_DefineSpace().
    pub fn nv_write_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_WriteResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command is used to increment the value in an NV Index that has the TPM_NT_COUNTER
    /// attribute. The data value of the NV Index is incremented by one.
    pub fn nv_increment_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_IncrementResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command extends a value to an area in NV memory that was previously defined by
    /// TPM2_NV_DefineSpace.
    pub fn nv_extend_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_ExtendResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// number of bits from 0 to 64 may be SET. The contents of bits are ORed with the current
    /// contents of the NV Index.
    pub fn nv_setbits_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_SetBitsResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// If the TPMA_NV_WRITEDEFINE or TPMA_NV_WRITE_STCLEAR attributes of an NV location are SET,
    /// then this command may be used to inhibit further writes of the NV Index.
    pub fn nv_writelock_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_WriteLockResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// The command will SET TPMA_NV_WRITELOCKED for all indexes that have their
    /// TPMA_NV_GLOBALLOCK attribute SET.
    pub fn nv_globalwritelock_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_GlobalWriteLockResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command reads a value from an area in NV memory previously defined by TPM2_NV_DefineSpace().
    ///     data - The data read
    pub fn nv_read_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_ReadResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.data)
    ...
    /// If TPMA_NV_READ_STCLEAR is SET in an Index, then this command may be used to prevent
    /// further reads of the NV Index until the next TPM2_Startup (TPM_SU_CLEAR).
    pub fn nv_readlock_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_ReadLockResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command allows the authorization secret for an NV Index to be changed.
    pub fn nv_changeauth_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_ChangeAuthResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    ///     certifyInfo - The structure that was signed
    ///     signature - The asymmetric signature over certifyInfo using the key referenced by signHandle
    pub fn nv_certify_complete(&mut self) -> Result<NV_CertifyResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = NV_CertifyResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    ///     moreData - Flag to indicate whether there are more values
    ///     capabilitiesData - List of capabilities
    pub fn ac_getcapability_complete(&mut self) -> Result<AC_GetCapabilityResponse, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = AC_GetCapabilityResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp)
    ...
    /// The purpose of this command is to send (copy) a loaded object from the TPM to an Attached Component.
    ///     acDataOut - May include AC specific data or information about an error.
    pub fn ac_send_complete(&mut self) -> Result<tpms_ac_output, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = AC_SendResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.ac_data_out)
    ...
    /// Component (AC). Qualification includes selection of the receiving AC and the method of
    /// authentication for the AC, and, in certain circumstances, the Object to be sent may be specified.
    pub fn policy_ac_send_select_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = Policy_AC_SendSelectResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This command is used to set the time remaining before an Authenticated Countdown Timer
    /// (ACT) expires.
    pub fn act_settimeout_complete(&mut self) -> Result<(), TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = ACT_SetTimeoutResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(())
    ...
    /// This is a placeholder to allow testing of the dispatch code.
    ///     outputData - Dummy data
    pub fn vendor_tcg_test_complete(&mut self) -> Result<vec<u8>, TpmError> {
        // Complete async command by receiving and processing response
        let mut resp = Vendor_TCG_TestResponse::default();
        self.tpm.dispatch_async_response(&mut resp)?;
        Ok(resp.output_data)
