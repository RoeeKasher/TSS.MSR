...
/// Maps enum type IDs to a map of values to string representations
    ...
    let mut map = HashMap::new();
        ...
        tpm_clock_adjust_map.insert(0xFFFFFFFD, "COARSE_SLOWER");
        tpm_clock_adjust_map.insert(0xFFFFFFFE, "MEDIUM_SLOWER");
        tpm_clock_adjust_map.insert(0xFFFFFFFF, "FINE_SLOWER");
        ...
        tpma_startup_clear_map.insert(0x80000000, "orderly");
        ...
        tpma_x509_key_usage_map.insert(0x80000000, "digitalSignature");
        ...
        tpma_nv_map.insert(0x80000000, "READ_STCLEAR");
    ...
    let mut map = HashMap::new();
        ...
        let mut tpm_clock_adjust_map = HashMap::new();
        tpm_clock_adjust_map.insert("COARSE_SLOWER", 0xFFFFFFFD);
        tpm_clock_adjust_map.insert("MEDIUM_SLOWER", 0xFFFFFFFE);
        tpm_clock_adjust_map.insert("FINE_SLOWER", 0xFFFFFFFF);
        ...
        tpma_startup_clear_map.insert("orderly", 0x80000000);
        map.insert(std::any::TypeId::of::<TPMA_STARTUP_CLEAR>(), tpma_startup_clear_map);
        ...
        tpma_x509_key_usage_map.insert("digitalSignature", 0x80000000);
        map.insert(std::any::TypeId::of::<TPMA_X509_KEY_USAGE>(), tpma_x509_key_usage_map);
        ...
        tpma_nv_map.insert("READ_STCLEAR", 0x80000000);
        map.insert(std::any::TypeId::of::<TPMA_NV>(), tpma_nv_map);
    ...
    let type_id = std::any::TypeId::of::<U>();
        ...
        if type_id == std::any::TypeId::of::<TPMU_KDF_SCHEME>() {
            match selector {
                ...
                TPM_ALG_ID:KDF1_SP800_56A as u32 => Some(Box::new(TPMU_KDF_SCHEME::Kdf1Sp80056a(TPMS_KDF_SCHEME_KDF1_SP800_56A::default()))),
                TPM_ALG_ID:KDF2 as u32 => Some(Box::new(TPMU_KDF_SCHEME::Kdf2(TPMS_KDF_SCHEME_KDF2::default()))),
                TPM_ALG_ID:KDF1_SP800_108 as u32 => Some(Box::new(TPMU_KDF_SCHEME::Kdf1Sp800108(TPMS_KDF_SCHEME_KDF1_SP800_108::default()))),
