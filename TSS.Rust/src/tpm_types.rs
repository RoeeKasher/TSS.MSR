...
impl TpmStructure for TPMS_CAPABILITY_DATA {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeInt(self.data.unwrap().GetUnionSelector());
...
impl TpmStructure for TPMS_ATTEST {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.attested.unwrap().GetUnionSelector());
...
impl TpmStructure for TPMT_KEYEDHASH_SCHEME {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.details.unwrap().GetUnionSelector());
...
impl TpmStructure for TPMS_ALGORITHM_DETAIL_ECC {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.kdf.unwrap().GetUnionSelector());
        self.kdf.unwrap().toTpm(buf);
        buf.writeShort(self.sign.unwrap().GetUnionSelector());
...
impl TpmStructure for TPMT_SIGNATURE {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.signature.unwrap().GetUnionSelector());
...
impl TpmStructure for TPMS_KEYEDHASH_PARMS {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.scheme.unwrap().GetUnionSelector());
...
impl TpmStructure for TPMT_PUBLIC_PARMS {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.parameters.unwrap().GetUnionSelector());
...
impl TpmStructure for TPMT_SENSITIVE {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.sensitive.unwrap().GetUnionSelector());
...
impl TpmStructure for TPM2_RSA_Encrypt_REQUEST {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.inScheme.unwrap().GetUnionSelector());
...
impl TpmStructure for TPM2_PolicySigned_REQUEST {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.auth.unwrap().GetUnionSelector());
...
impl TpmStructure for TPM2_FieldUpgradeStart_REQUEST {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeShort(self.manifestSignature.unwrap().GetUnionSelector());
...
impl TpmStructure for GetCapabilityResponse {
    ...
    fn serialize(&self, buf: &mut TpmBuffer) -> Result<(), TpmError> {
        ...
        buf.writeInt(self.capabilityData.unwrap().GetUnionSelector());
